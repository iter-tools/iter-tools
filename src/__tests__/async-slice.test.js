/**
 * @generated-from ./slice.test.template.js
...
import { $slice, $toArray } from './async-fns'
const $methodName = 'asyncSlice'
describe($methodName, () => {

...
declare function splitOnAny(separatorValues: SyncSourceIterable<string>, compareEquality?: (value: string, item: string) => boolean): (source: string) => ResultIterable<string>;
...
declare function splitOnAny(separatorValues: SyncSourceIterable<string>, compareEquality: (value: string, item: string) => boolean, source: string): ResultIterable<string>; // prettier-ignore

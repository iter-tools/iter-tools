...
declare function splitOnSubseq(separatorSubseq: SourceIterable<string>, compare?: (value: string, item: string) => boolean): (source: string) => ResultIterable<string>;
...
declare function splitOnSubseq(separatorSubseq: SourceIterable<string>, compare: (value: string, item: string) => boolean, source: string): ResultIterable<string>; // prettier-ignore

...
assert<ResultIterable<number>>(
  flat(5, Ø as Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<number>>>>>>)
);
// prettier-ignore
assert<ResultIterable<number>>(flat(
  6,
  Ø as Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<number>>>>>>>
));
// prettier-ignore
assert<ResultIterable<number>>(flat(
  7,
  Ø as Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<number>>>>>>>>
));

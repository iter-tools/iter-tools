...
// prettier-ignore
assert<$GeneratorIterator<number>>($flat(1, Ø as $Iterable<$Iterable<number>>));
// prettier-ignore
assert<$GeneratorIterator<number>>($flat(2, Ø as $Iterable<$Iterable<$Iterable<number>>>));
// prettier-ignore
assert<$GeneratorIterator<number>>($flat(3, Ø as $Iterable<$Iterable<$Iterable<$Iterable<number>>>>));
// prettier-ignore
assert<$GeneratorIterator<number>>($flat(4, Ø as $Iterable<$Iterable<$Iterable<$Iterable<$Iterable<number>>>>>));
// prettier-ignore
assert<$GeneratorIterator<number>>($flat(5, Ø as $Iterable<$Iterable<$Iterable<$Iterable<$Iterable<$Iterable<number>>>>>>));
// prettier-ignore
assert<$GeneratorIterator<number>>($flat(6, Ø as $Iterable<$Iterable<$Iterable<$Iterable<$Iterable<$Iterable<$Iterable<number>>>>>>>));
// prettier-ignore
assert<$GeneratorIterator<number>>($flat(7, Ø as $Iterable<$Iterable<$Iterable<$Iterable<$Iterable<$Iterable<$Iterable<$Iterable<number>>>>>>>>));

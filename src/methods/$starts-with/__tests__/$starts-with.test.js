...
describe($`startsWith`, () => {
  ...
  it(
    'returns true if the iterable starts with the given value using the given equality comparator',
    $async(() => {
      expect($await($startsWith('1', (a, b) => a === b.toString(), range(1, 10)))).toBe(true);
    }),
  );

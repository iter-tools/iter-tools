...
declare function splitOnAnySubseq(separatorSubseqs: SyncSourceIterable<SourceIterable<string>>, compareEquality?: (value: string, item: string) => boolean): (source: string) => ResultIterable<string>;
...
declare function splitOnAnySubseq(separatorSubseqs: SyncSourceIterable<SourceIterable<string>>, compareEquality: (value: string, item: string) => boolean, source: string): ResultIterable<string>; // prettier-ignore

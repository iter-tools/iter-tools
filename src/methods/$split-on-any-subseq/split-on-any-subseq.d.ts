...
import { SourceIterable } from '../../types/iterable'; // curried
// prettier-ignore

declare function splitOnAnySubseq(separatorSubseqs: SyncSourceIterable<SourceIterable<string>>, compare?: (value: string, item: string) => boolean): (source: string) => ResultIterable<string>;
...
declare function splitOnAnySubseq(separatorSubseqs: SyncSourceIterable<SourceIterable<string>>, compare: (value: string, item: string) => boolean, source: string): ResultIterable<string>; // prettier-ignore

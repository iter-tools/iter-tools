...
export { default as splitWhen } from './split-when';
...
export { default as takeLastOr } from './take-last-or';
...
export { default as asyncSplitWhen } from './async-split-when';
...
export { default as asyncTakeLast } from './async-take-last';
export { default as asyncTakeLastOr } from './async-take-last-or';

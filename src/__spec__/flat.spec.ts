...
assert<IterableIterator<number>>(flat(0, (Ø as Iterable<number>))); // prettier-ignore

assert<IterableIterator<number>>(flat(1, (Ø as Iterable<Iterable<number>>))); // prettier-ignore

assert<IterableIterator<number>>(flat(2, (Ø as Iterable<Iterable<Iterable<number>>>))); // prettier-ignore

assert<IterableIterator<number>>(flat(3, (Ø as Iterable<Iterable<Iterable<Iterable<number>>>>))); // prettier-ignore

assert<IterableIterator<number>>(flat(4, (Ø as Iterable<Iterable<Iterable<Iterable<Iterable<number>>>>>))); // prettier-ignore

assert<IterableIterator<number>>(flat(5, (Ø as Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<number>>>>>>))); // prettier-ignore

assert<IterableIterator<number>>(flat(6, (Ø as Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<Iterable<number>>>>>>>))); // prettier-ignore

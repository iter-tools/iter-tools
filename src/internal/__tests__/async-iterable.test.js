...
const { ensureAsyncIterable, isAsyncIterable, asyncIterableCurry, asyncify } = require('../async-iterable')
const { range, asyncToArray } = require('../..')
...
describe('asyncIterableCurry', function () {
  ...
  it('curries with empty invocations', async function () {
    expect(await asyncToArray(c2()(hello)(world)([]))).toEqual([hello, world])
    expect(await asyncToArray(c2(hello)()(world)([]))).toEqual([hello, world])
    expect(await asyncToArray(c2(hello)(world)()([]))).toEqual([hello, world])
    expect(await asyncToArray(c1()(hello)()([]))).toEqual([hello])

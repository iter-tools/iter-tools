...
export const asyncIterableCurry = (fn, minArgs, maxArgs) => variadicCurryWithValidation(isValidAsyncIterableArgument, 'asyncIterable', ensureAsyncIterable, fn, minArgs, maxArgs)

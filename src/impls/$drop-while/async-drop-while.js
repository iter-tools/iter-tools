...
export function __asyncDropWhile(_x, _x2) {
  return _$__dropWhile.apply(this, arguments);
}

function _$__dropWhile() {
  _$__dropWhile = _wrapAsyncGenerator(function* (source, predicate) {
    let drop = true;
    let c = 0;
    ...
    try {
      ...
      for (
        ...
        if (!drop) {
          ...
          drop = yield _awaitAsyncGenerator(predicate(value, c++));
          if (!drop) {
            yield value;
          }
        }

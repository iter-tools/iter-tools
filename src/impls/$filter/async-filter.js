...
export function __asyncFilter(_x, _x2) {
  return _$__filter.apply(this, arguments);
}

function _$__filter() {
  _$__filter = _wrapAsyncGenerator(function* (source, predicate) {
    let c = 0;
    ...
    try {
      ...
      for (
        ...
        if (yield _awaitAsyncGenerator(predicate(value, c++))) {
          yield value;
        }
      }
    } catch (err) {

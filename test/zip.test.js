...
const zipES6 = require('../dist/es2018/zip')
const zipES5 = require('../dist/es5/zip')

const asyncZipES6 = require('../dist/es2018/async-zip')
const asyncZipES5 = require('../dist/es5/async-zip')

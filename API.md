...
**min([compare](#compare), [iterable](#wrappable))**  
**min([iterable](#wrappable))**  
**__min([iterable](#iterable), ?[compare](#compare))**  

`min` is undocumented.

### asyncMin

**asyncMin([compare](#compare), [iterable](#asyncwrappable))**  
**asyncMin([iterable](#asyncwrappable))**  
